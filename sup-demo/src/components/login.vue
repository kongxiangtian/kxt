<template>
    ...
    <div>
	   ...
	   <div>
		...
		<x-button :gradients="['#1D62F0', '#19D5FD']" @click.native="login" style="position:absolute;left:0px;top:400px;">登录</x-button>
		<x-button :gradients="['#1D62F0', '#19D5FD']" link="/zhuce" style="position:absolute;left:0px;top:450px;" >注册</x-button>
		</div>
    </div>
  ...
  methods:{
    ...
    login(){
        if(this.name == "" || this.password == ""){
			...
			let self=this;
			this.$axios.post('http://47.103.17.177:80/login',{

<template>
	<div class="demo"> 
	<x-header :right-options="{showMore: true}" @on-click-more="showMenus = true">axios笔记</x-header>
	<group>
    <x-textarea  max="300"  name="description"  @on-focus="onEvent('focus')" @on-blur="onEvent('blur')"  title="" v-model="value"></x-textarea>
  </group>
  <div xialakuang>

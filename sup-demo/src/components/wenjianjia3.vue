...
<template>
  <div class="demo">
   <x-header :right-options="{showMore: true}" @on-click-more="showMenus = true">我的文件夹/文件夹1/PHP</x-header>
 <search
		...
		onaddwenjianjia(){
			var result1 = prompt("新建文件夹","demo"); 
		        ...
		        alert(  "文件夹"+result1+"创建成功");
						 this.$router.push({path: '/wenjianjia3'})
